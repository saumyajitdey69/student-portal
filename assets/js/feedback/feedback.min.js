...
$("#t_submit").click(function () {
    ...
    $.ajax({
        ...
        success: function (e, t, n) {
            if (e == 3) {
                //show_error("All questions are mandatory.");
                notify("danger","Already filled for this subject");
                return
            }
            if (e == 2) {
                //show_error("All questions are mandatory.");
...
var message="Please fill the academic feedback honestly. Life mein no shortcuts.";
...
document.oncontextmenu=new Function("window.location.assign('/../student/auth/logout');alert(message);return false")
