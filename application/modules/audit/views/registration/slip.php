...
<form name="login" id="login" style="width:85%; min-width:500px; border-radius:10px; margin-top:5px;" method="POST" action="courseoffers.php">
    ...
    <div>
        ...
        <td style="width:60px; text-align:left;"><label><strong>Branch</strong></label></td>
        <td style="width:20px; text-align:center;"> : </td>
        <td style="width:400px; text-align:left;"><?php echo strtoupper($reg_branch); ?></td>

        <td style="width:60px; text-align:left;"><label><strong>Section</strong></label></td>
        <td style="width:20px; text-align:center;"> : </td>
        <td style="width:60px; text-align:left;"><?php echo $reg_section; ?><input type="hidden" name="sec" value="<?php echo $reg_section; ?>" required/></td>
    ...
    <div>
        <table>
        <tr>
        <td style="width:60px; text-align:left;"><label><strong>Course</strong></label></td>
        <td style="width:20px; text-align:center;"> : </td>
        <td style="width:400px; text-align:left;"><span id="class"><?php echo $reg_course; ?></span></td>
        <script>
            (function () {
                var classdesc;
                switch ("<?php echo $reg_course_names; ?>") {
                    case 'Physics Cycle':
        ...
        <td style="width:60px; text-align:left;"><label><strong>Semester</strong></label></td>
        <td style="width:20px; text-align:center;"> : </td>
    ...
    <table id = "regular_course_table" border="1">
            ...
            foreach ($reg_study_exam as $key => $value){
                if($value === "sb" || $value === "e"){
                    $flag = 1;
                    continue;
                }
    ...
    <div>
        <table>
        <tr>
        <td style="width:250px; text-align:left;"><strong>Total Credits(Study Only)</strong></td>
        <td style="width:20px; text-align:center;"> : </td>
        <td style="width:20px; text-align:left;"><?php echo $reg_credits_study; ?></td>
        <td style="width:250px;"><label><strong>Total Credits(Study+Exam)</label></strong></td>
        <td style="width:20px; text-align:center;"> : </td>
        <td style="width:20px;"><?php echo $reg_credits_study_exam; ?></td>
        </tr>
        </table>
    </div>
