...
//global ewc charges
$ewc_charge = 4500;
$allowed_student_types = array(71,72,73,74,76,77,78,79,80,81,82,83,84,85,86,87,88,89,90,91,95,94,102,103,39,47,55,63,41,49,57,65,104,43,51,59,67,107,45,53,61,69,40,48,56,64,42,50,58,66,105,44,52,60,68,106,46,46,54,62,70,46,94,95,102,103);

$iccr_ids = array(55,56,57,58,59,60,61,62);
class Hostels extends CI_Controller {
    ...
    {
        echo "string";
        #$regno = $this->userid_to_regno($this->nativesession->get('userid'));
        #echo $regno;
        return $this->studentmodel->is_neft($regno);
    }
