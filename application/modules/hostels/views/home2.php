		...
		<div class="col-xs-12 col-sm-6 col-md-9 col-lg-9">
			<?php if(isset($error)){ 
				...
				<p class = "alert alert-warning" > <?php 
					...
					<?php   if(isset($slip)){ ?>
					<a href="<?php echo $slip_url; ?>" class = "btn btn-success btn-block btn-lg">Allotment Slip</a>
					<?php }else if(isset($allowed_allotment)){
						if($allowed_allotment){ ?>
						<a href="<?php echo $allotment_url; ?>" class = "btn btn-success btn-block btn-lg">Go for hostel allotment</a>
						<?php } ?>
						<?php }  ?>
						<?php } ?>
						<?php } ?>
						...
						<div class="well">
							...
							<!-- <div class="well"> 
								2nd Year ICCR students, please start booking your new rooms in 1k (Mega Hostel) <br>
								2nd year ICCR students are requested to vacate the rooms in ISH before 12:00 pm
								<br>
							...
							<ul>
								<li>
									Please make sure that you have entered correct details on audit profile and also correct registration number.
								</li>
								<li>
									If the payment is not approved in two days please send an email to wsdc.nitw@gmail.com on the third day, any email sent regarding this within two days of transactin may lead to blocking the account for 24 hours. 
									<br>
									NOTE: WSDC-collect may take 3 days for approval.
								</li>
								<li>
									Please check the amount paid, calculation on bank receipt and eligibility list before sending any email to wsdc, irrelevant email or spam calling may leads to blocking of account for 24 hours
								</li>
								<li>
									Please be careful while filling all the details. It may take minimum of 2 days for corrections (if any)
								</li>
								<li>
									In case due to technical circumstances or heavy traffic single room is allotted to more than one student, the first one who book the room will retain his allotment and other have to compromize with remaining rooms left. Please notify us as soon as you noticed any such discrepency
								</li>
							</ul>
						</div>

						<legend id="transacitonsummary">
							Transaction Summary of <strong><?php echo $regno ?></strong>
						</legend>
